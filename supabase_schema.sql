...
-- (d) Isso é uma decisão consciente, não um erro: este é um app de uso
--     pessoal, sem dado além de finanças pessoais, sem divulgação pública
--     da URL e sem listagem/indexação em lugar nenhum — o "segredo" de fato
--     é a própria URL não ser conhecida por mais ninguém.
-- (e) Se a URL deste app deixar de ser só sua (compartilhar com mais gente,
--     divulgar em algum lugar, etc.), a camada de proteção real a
